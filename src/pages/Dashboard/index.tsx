...
const Dashboard: React.FC = () => {
  ...
  /* const turnAppointments = useMemo<TurnAppointments>(() => {
    const morning: Appointment[] = [];
    const afternoon: Appointment[] = [];

    appointments.forEach(appointment => {
      if (parseISO(appointment.date).getHours() < 12) {
      ...
      <Content>
        <Schedule>
          ...
          <Section>
            ...
            {morningAppointments.map((appointment, index) => (
              <Appointment key={`${appointment.id}-${index}`}>
                <span>
                  <FiClock />
          ...
          <Section>
            ...
            {afternoonAppointments.map((appointment, index) => (
              <Appointment key={`${appointment.id}-${index}`}>
                <span>
                  <FiClock />
                  {appointment.hourFormatted}
